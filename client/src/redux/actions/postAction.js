...
export const createPost = ({
  ...
  try {
    ...
    const res = await postDataAPI(
      "posts",
      { content, contentsub, community, title, images: media, images2: media2 /* added title, images2: media2*/},
      auth.token
    );
...
export const updatePost = ({
  ...
  try {
    ...
    const res = await patchDataAPI(
      `post/${status._id}`,
      { content, contentsub, community, title,images: [...imgOldUrl, ...media],images2: [...imgOldUrl2, ...media2] /* added title, images2: [...imgOldUrl2, ...media2]*/},
      auth.token
    );
